...
const colors = ["red", "orange", "yellow", "green", "white", "black", "cyan", "tomato", "pink", "blue"];
...
function onClickCard() {
  ...
  const firstBack = clicked[0].querySelector(".card-back").style.backgroundColor;
  const secondBack = clicked[1].querySelector(".card-back").style.backgroundColor;
